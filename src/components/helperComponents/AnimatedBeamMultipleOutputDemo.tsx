            ...
            <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
                <div className="flex flex-col justify-center gap-2 ">
                    ...
                    <div className="relative flex items-center justify-center  ">
                        <div className="w-12  h-12  rounded-full flex items-center justify-center relative">
                            <div
                                className="absolute w-1/2 h-1/2 bg-gradient-to-br from-slate-100 via-slate-200 to-purple-200 rounded-full blur-md "></div>
                            <Circle
                                className="bg-transparent  border-0 relative z-10 w-full h-full flex items-center justify-center"
                                ref={div1Ref}>
                                <Icons.notion/>
                            </Circle>
                        </div>
                ...
                <div className="flex flex-col justify-center">
                    <div className="relative flex items-center justify-center  ">
                        <div className="w-16  h-16  rounded-full flex items-center justify-center relative">
                            <div
                                className="absolute w-full h-full bg-gradient-to-r from-slate-900 via-netural-400 to-neutral-100 rounded-full blur-lg  "></div>
                            <Circle
                                className="bg-transparent   border-0 relative z-10 w-full h-full flex items-center justify-center"
                                ref={div6Ref}>
                                {/*<Icons.openai/>*/}
                ...
                <div className="flex flex-col justify-center  mt-1 ">
                    <div className="relative flex items-center justify-center  ">
                        <div className="w-12  h-12  rounded-full flex items-center justify-center relative">
                            <div
                                className="absolute z-999 w-full h-full  rounded-full   "></div>
                            <Circle
                                className="bg-transparent   border-0 relative z-10 w-full h-full flex items-center justify-center"
                                ref={div7Ref}>
                                <Icons.user/>
